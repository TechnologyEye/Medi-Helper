...
<br/><br/>
    		...
    		<div class="container">
                ...
                <section id="reports" class="portlet box blue reportTable" ng-show="show_reports">
                   <div class="portlet-title">
                    <div class="caption">
                     <i class="fa fa-comments"></i>Listing Appointment
                 </div>
                 <a href="add_appointment_patient.jsp">
                 <input type="button" ng-click="" value="Add Appointment" class="pull-right btn purple"></a>
   ...
   <div class="portlet-body">
    	...
    	try {
    	    ...
    	    ps = con.prepareStatement("select * from appointments where appt_patient_id=? ");	
    		...
    		if(rs.next())
    		{
    			...
    			ps.setInt(1, rs.getInt(3));
    			 ...
    			 rs3.next();
  	    			...
  	    			ps=con.prepareStatement("select treatm_name from treatements where treatm_id=?");
            ...
            %>
                                   ...
                                   {
		                                %>
		                                <span style="color:#4099ff">New</span>
		                                <%	   
                                   }
                                   if(p==1)
                                   {
		                                %>
		                                <span style="color:#4099ff">Confirm</span>
		                                <%	   
                                   }
                                   if(p==2)
                                   {
		                                %>
		                                <span style="color:#4099ff">Cancel</span>
		                                <%	   
                                   }
                                   %>
