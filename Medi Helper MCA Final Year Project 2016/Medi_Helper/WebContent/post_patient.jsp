    			...
    			<div class="row">
    				...
    				<div class="col-sm-2 sidebar" style="margin-top:30px;">
    					<div class="profileDet" ng-controller="ImageUploadController">
    						...
    						<form action="storeimageservlet" enctype="multipart/form-data">
                    ...
                    <form action="add_post_patient.jsp">
               	...
               	try {
                      ...
                      <div class="postSec" class="ng-scope" ng-show="show_post">
                       ...
                       <div class="col-sm-3" class="ng-binding">
                        ...
                        <img ng-if="post.user_profileimg" src="images/patient-man.jpg" class="img-responsive" alt="Generic placeholder thumbnail">
