...
try
{
	...
	ps=con.prepareStatement("insert into appointments(appt_patient_id,appt_doctor_id,appt_treatement_id,appt_booked_datetime,appt_notes)values(?,?,?,?,?)");
    ps.setInt(1, id);
	ps.setInt(2, doc_id);
	...
	<jsp:forward page="appointments_patient.jsp"></jsp:forward>
