...
%>
	...
	try {
	    ...
	    ps = con.prepareStatement("select * from report where rept_user_id=?");	
	...
	%>
         ...
         <td class="ng-binding"><%=rs.getString(7)%></td>
           ...
           <td>
             <span ng-click="" class="btn default btn-xs purple">
   <a href=edit_report.jsp?srno=<%=rs.getInt(1)%>> <i class="fa fa-edit"></i> Edit </span>
          </td>
         
          <td>
          <span ng-click="" class="btn default btn-xs green">
   <a href=view_report.jsp?srno=<%=rs.getInt(1)%>> <i class="fa fa-edit"></i> view </span></a>
           </td>
           
            <td>
               <span ng-click="" class="btn default btn-xs danger ">
  <a href=delet_report.jsp?srno=<%=rs.getInt(1)%>> <i class="fa fa-edit"></i> delete </span></a> 
            </td>
          </tr>
