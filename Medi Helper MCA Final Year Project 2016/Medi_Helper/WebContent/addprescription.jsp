...
<body>
	...
	<%	
 		    ...
 		    String doctore_name=request.getParameter("doctore_nm");
			int doc_id=Integer.parseInt(doctore_name);
...
try
{
	...
	ps=con.prepareStatement("insert into prescription(prescription_from_date,prescription_to_date,prescription_insulin,prescription_tablet,prescription_number_of_close,prescription_time,prescription_doctore_id,prescription_patient_id,prescription_time1,prescription_time2,prescription_time3,prescription_time4)values(?,?,?,?,?,?,?,?,?,?,?,?)");
	...
	<jsp:forward page="prescription_patient.jsp"></jsp:forward>
