	...
	<meta name="viewport"
		...
		<meta name="description" content="">
			<meta name="author" content="">
				...
				<title>Dia Care</title> <script type="text/javascript">
					function preloader() {
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a href="post_patient.jsp">Home</a></li>

					<li ng-show="logged"><a href="report_patient.jsp">Reports</a>
					</li>
					<!-- <li ng-show="logged" class="page-scroll">
                        <a href="#appointment">Appointments</a>
                    </li> -->

					<li ng-show="logged"><a href="appointments_patient.jsp">Appointments</a>
					</li>

					<li ng-show="logged"><a href="prescription_patient.jsp">Prescriptions</a>
					</li>

					<li ng-show="logged">
						<!-- <a href="#profile">Profile</a> --> <a
						href="profile_patient.jsp">Profile</a>
					</li>
...
%></span></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-2 sidebar" style="margin-top: 30px;">
					<div class="profileDet" ng-controller="ImageUploadController">
						<div class="profilePic">
							<img id="imgprvw1" src="images/" height="100px" alt="First slide" />
						</div>
					...
					<ul class="nav nav-sidebar leftSidebar"
						...
						<li><a href="add_appoitntment_patient.jsp" data-toggle="modal" data-target="#myModal2">Fill Appointment</a></li>
				...
				<div class="col-sm-8 col-sm-offset-2 main" style="margin-top: 30px;">
					...
					<center>
						<h1>
							<font color="#0099FF" size="+2">Update</font>
						</h1>
						<form class="form-group" action="updatereport.jsp">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<select class="form-control" id="sel3" name="doctore_nm">
										...
										<%
											try {
												 con.prepareStatement("select user_id,user_username from user where user_type=2 ");
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<input type="text" name="report_nm" placeholder="Report Name" class="form-control" />
							...
							<div class="row">
								<div class="col-sm-4">Report Date</div>
								<div class="col-sm-6">
									<input type="date" name="report_dat" placeholder="Report Date"
										class="form-control" />
							...
							<div class="row">
								<div class="col-sm-4">Report Start Time</div>
								<div class="col-sm-6">
									<input type="time" name="report_st_time" class="form-control" />
							...
							<div class="row">
								<div class="col-sm-4">Report End Time</div>
								<div class="col-sm-6">
									<input type="time" name="report_nd_time" class="form-control" />
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<select class="form-control" id="sel3" name="report_typ">
										<option></option>
							...
							<div class="row">
								<div class="col-sm-4">Blood Sugar (mg/dl)</div>
								<div class="col-sm-6">
									<input type="text" name="blood_sug" placeholder="Blood Sugar"
										class="form-control" />
								</div>
							</div>
							<br />
							...
							<br />
							<div class="row">
								<div class="col-sm-4">Carb</div>
								<div class="col-sm-6">
									<input type="text" name="crb" placeholder="Carb"
										class="form-control" />
								</div>
							</div>
							<br />
							<div class="row">
								<div class="col-sm-4">Physical Activity</div>
								<div class="col-sm-6">
									<input type="text" name="physical_act"
										placeholder="Physical Activity" class="form-control" />
								</div>
							</div>
							<br />
							<div class="row">
	...
	<script type="text/javascript"
		src="<?php echo base_url();?>js/jquery_1.10.2_jquery.min.js"></script>
	<script type="text/javascript"
		src="<?php echo base_url();?>js/jquery_1.11.1_jquery.validate.min.js"></script>
