...
try
{
	...
	ps=con.prepareStatement("insert into report(rept_user_id,rept_doctor_id,rept_name,rept_type,rept_desc,rept_createdon,rept_endtime,rept_blood_sugar,rept_card,rept_physical_activity,insulin,rept_starttime)values(?,?,?,?,?,?,?,?,?,?,?,?)");
    ps.setInt(1, id);
	ps.setInt(2, doc_id);
	...
	<jsp:forward page="report_patient.jsp"></jsp:forward>
