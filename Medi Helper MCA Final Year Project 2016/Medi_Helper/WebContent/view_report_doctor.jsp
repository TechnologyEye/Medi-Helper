...
%>
	...
	%>
         ...
         <td class="ng-binding"> <%=rs.getString(8)%> </td>
         <td class="ng-binding"> <%=rs.getString(9)%> </td>

        
         <td class="ng-binding"><%=rs.getString(10)%></td>
             
         <td class="ng-binding"><%=rs.getString(11)%></td>
          
           <td class="ng-binding"><%=rs.getString(12)%></td>
