		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li ng-show="logged" class="page-scroll"><a href="logout.jsp"> <span
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-8 col-sm-offset-2 main" style="margin-top: 30px;">
					...
					<center>
						<h1>
							<font color="#0099FF" size="+2">Add Report</font>
						</h1>
						<form class="form-group" action="addreport.jsp">
							<br />
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<input type="text" name="report_nm" placeholder="Report Name"
										class="form-control" />
								</div>
							</div>
							<br />
