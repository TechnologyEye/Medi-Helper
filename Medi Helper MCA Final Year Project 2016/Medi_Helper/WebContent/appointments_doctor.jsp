...
<br/><br/>
   ...
   <div class="portlet-body">
    	...
    	try {
    	    ...
    	    ps = con.prepareStatement("select * from appointments where appt_doctor_id=? ");	
            ...
            %>
                                   ...
                                   <td> 
   										...
   										<span style="color:#ffa54f"><a href=confirm_appo_doctor.jsp?srno=<%=rs.getInt(1)%>><i class="fa fa-edit"></i>Confirm</span></a>
   										<span style="color:#ffa54f"><a href=delet_appo_doctor.jsp?srno=<%=rs.getInt(1)%>><i class="fa fa-edit"></i>Cancel</span></a>
