	...
	<meta name="viewport"
		...
		<meta name="description" content="">
			<meta name="author" content="">
				...
				<title>Medi_Helper</title> <script type="text/javascript">
					function preloader() {
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li ng-show="logged" class="page-scroll"><a href="logout_doctor.jsp"> <span
			...
			<div class="row">
				...
				<div class="col-sm-8 col-sm-offset-2 main" style="margin-top: 30px;">
					...
					<center>
						...
						<form class="form-group" action="addreport_doctor.jsp">
							<br />
							<div class="row">
